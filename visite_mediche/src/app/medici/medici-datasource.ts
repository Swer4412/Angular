 ...
 */
export class MediciDataSource extends DataSource<MedicoDTO> {
  data: MedicoDTO[] = [];
   ...
   */
  private getPagedData(data: MedicoDTO[]): MedicoDTO[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: MedicoDTO[]): MedicoDTO[] {
